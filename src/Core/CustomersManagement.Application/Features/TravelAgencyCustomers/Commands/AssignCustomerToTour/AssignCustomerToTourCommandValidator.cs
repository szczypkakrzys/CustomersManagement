...
public class AssignCustomerToTourCommandValidator : AbstractValidator<AssignCustomerToTourCommand>
{
    ...
    public AssignCustomerToTourCommandValidator(
    ...
    private Task<bool> CustomerIsNotAlreadyAssingedToGivenTour(
        AssignCustomerToTourCommand command,
